...
module lms_ctr_mm_interconnect_0 (
	...
	wire   [7:0] rsp_mux_001_src_channel;                                                         // rsp_mux_001:src_channel -> nios2_cpu_instruction_master_agent:rp_channel
	...
	wire  [93:0] av_fifo_int_0_avalon_slave_0_agent_rf_source_data;                               // Av_FIFO_Int_0_avalon_slave_0_agent:rf_source_data -> Av_FIFO_Int_0_avalon_slave_0_agent_rsp_fifo:in_data
	...
	wire  [93:0] av_fifo_int_0_avalon_slave_0_agent_rsp_fifo_out_data;                            // Av_FIFO_Int_0_avalon_slave_0_agent_rsp_fifo:out_data -> Av_FIFO_Int_0_avalon_slave_0_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_src_data;                                                                // cmd_mux:src_data -> Av_FIFO_Int_0_avalon_slave_0_agent:cp_data
	wire         cmd_mux_src_ready;                                                               // Av_FIFO_Int_0_avalon_slave_0_agent:cp_ready -> cmd_mux:src_ready
	wire   [7:0] cmd_mux_src_channel;                                                             // cmd_mux:src_channel -> Av_FIFO_Int_0_avalon_slave_0_agent:cp_channel
	...
	wire  [93:0] oc_mem_s1_agent_rf_source_data;                                                  // oc_mem_s1_agent:rf_source_data -> oc_mem_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] oc_mem_s1_agent_rsp_fifo_out_data;                                               // oc_mem_s1_agent_rsp_fifo:out_data -> oc_mem_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_003_src_data;                                                            // cmd_mux_003:src_data -> oc_mem_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                           // oc_mem_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [7:0] cmd_mux_003_src_channel;                                                         // cmd_mux_003:src_channel -> oc_mem_s1_agent:cp_channel
	...
	wire  [93:0] lms_ctr_gpio_s1_agent_rf_source_data;                                            // lms_ctr_gpio_s1_agent:rf_source_data -> lms_ctr_gpio_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] lms_ctr_gpio_s1_agent_rsp_fifo_out_data;                                         // lms_ctr_gpio_s1_agent_rsp_fifo:out_data -> lms_ctr_gpio_s1_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_valid;                                                           // cmd_mux_006:src_valid -> lms_ctr_gpio_s1_agent:cp_valid
	wire  [92:0] cmd_mux_006_src_data;                                                            // cmd_mux_006:src_data -> lms_ctr_gpio_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                           // lms_ctr_gpio_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [7:0] cmd_mux_006_src_channel;                                                         // cmd_mux_006:src_channel -> lms_ctr_gpio_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                   // cmd_mux_006:src_startofpacket -> lms_ctr_gpio_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                     // cmd_mux_006:src_endofpacket -> lms_ctr_gpio_s1_agent:cp_endofpacket
	...
	wire  [93:0] spi_lms_spi_control_port_agent_rf_source_data;                                   // spi_lms_spi_control_port_agent:rf_source_data -> spi_lms_spi_control_port_agent_rsp_fifo:in_data
	...
	wire  [93:0] spi_lms_spi_control_port_agent_rsp_fifo_out_data;                                // spi_lms_spi_control_port_agent_rsp_fifo:out_data -> spi_lms_spi_control_port_agent:rf_sink_data
	...
	wire         cmd_mux_007_src_valid;                                                           // cmd_mux_007:src_valid -> spi_lms_spi_control_port_agent:cp_valid
	wire  [92:0] cmd_mux_007_src_data;                                                            // cmd_mux_007:src_data -> spi_lms_spi_control_port_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                           // spi_lms_spi_control_port_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [7:0] cmd_mux_007_src_channel;                                                         // cmd_mux_007:src_channel -> spi_lms_spi_control_port_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                                   // cmd_mux_007:src_startofpacket -> spi_lms_spi_control_port_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                     // cmd_mux_007:src_endofpacket -> spi_lms_spi_control_port_agent:cp_endofpacket
	...
	wire  [92:0] av_fifo_int_0_avalon_slave_0_agent_rp_data;                                      // Av_FIFO_Int_0_avalon_slave_0_agent:rp_data -> router_002:sink_data
	...
	wire  [92:0] oc_mem_s1_agent_rp_data;                                                         // oc_mem_s1_agent:rp_data -> router_005:sink_data
	...
	wire         lms_ctr_gpio_s1_agent_rp_valid;                                                  // lms_ctr_gpio_s1_agent:rp_valid -> router_008:sink_valid
	wire  [92:0] lms_ctr_gpio_s1_agent_rp_data;                                                   // lms_ctr_gpio_s1_agent:rp_data -> router_008:sink_data
	wire         lms_ctr_gpio_s1_agent_rp_ready;                                                  // router_008:sink_ready -> lms_ctr_gpio_s1_agent:rp_ready
	wire         lms_ctr_gpio_s1_agent_rp_startofpacket;                                          // lms_ctr_gpio_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         lms_ctr_gpio_s1_agent_rp_endofpacket;                                            // lms_ctr_gpio_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         spi_lms_spi_control_port_agent_rp_valid;                                         // spi_lms_spi_control_port_agent:rp_valid -> router_009:sink_valid
	wire  [92:0] spi_lms_spi_control_port_agent_rp_data;                                          // spi_lms_spi_control_port_agent:rp_data -> router_009:sink_data
	wire         spi_lms_spi_control_port_agent_rp_ready;                                         // router_009:sink_ready -> spi_lms_spi_control_port_agent:rp_ready
	wire         spi_lms_spi_control_port_agent_rp_startofpacket;                                 // spi_lms_spi_control_port_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         spi_lms_spi_control_port_agent_rp_endofpacket;                                   // spi_lms_spi_control_port_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire         lms_ctr_gpio_s1_agent_rdata_fifo_src_valid;                                      // lms_ctr_gpio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] lms_ctr_gpio_s1_agent_rdata_fifo_src_data;                                       // lms_ctr_gpio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         lms_ctr_gpio_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_006:in_0_ready -> lms_ctr_gpio_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                               // avalon_st_adapter_006:out_0_valid -> lms_ctr_gpio_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                // avalon_st_adapter_006:out_0_data -> lms_ctr_gpio_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                               // lms_ctr_gpio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                               // avalon_st_adapter_006:out_0_error -> lms_ctr_gpio_s1_agent:rdata_fifo_sink_error
	wire         spi_lms_spi_control_port_agent_rdata_fifo_src_valid;                             // spi_lms_spi_control_port_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] spi_lms_spi_control_port_agent_rdata_fifo_src_data;                              // spi_lms_spi_control_port_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         spi_lms_spi_control_port_agent_rdata_fifo_src_ready;                             // avalon_st_adapter_007:in_0_ready -> spi_lms_spi_control_port_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                               // avalon_st_adapter_007:out_0_valid -> spi_lms_spi_control_port_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                                // avalon_st_adapter_007:out_0_data -> spi_lms_spi_control_port_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                               // spi_lms_spi_control_port_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                               // avalon_st_adapter_007:out_0_error -> spi_lms_spi_control_port_agent:rdata_fifo_sink_error
	...
	lms_ctr_mm_interconnect_0_router_004 router_004 (
	...
	lms_ctr_mm_interconnect_0_router_004 router_005 (
	...
	lms_ctr_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_main_clk_clk),                            //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lms_ctr_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_main_clk_clk),                            //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
