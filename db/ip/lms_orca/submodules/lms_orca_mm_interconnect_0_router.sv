...
module lms_orca_mm_interconnect_0_router_default_decode
  #(
...
module lms_orca_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD9 = log2ceil(64'h110d8 - 64'h110d0); 
    // -------------------------------------------------------
    ...
    lms_orca_mm_interconnect_0_router_default_decode the_default_decode(
    ...
    // ( 0x110d0 .. 0x110d8 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 17'h110d0  && read_transaction  ) begin
